                ...
                <div className="bg-white rounded-xl border border-gray-100 p-5">
                  ...
                  {createAccount && (
                    <div className="mt-4 space-y-3">
                      ...
                      <div className="flex flex-col gap-2">
                        <p className="text-xs text-gray-400 text-center">Sign up quickly with:</p>
                        <div className="flex gap-2">
                          <a
                            href={`${typeof API_BASE !== 'undefined' ? API_BASE : ''}/api/auth/google`}
                            className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                          >
                          ...
                          <a
                            href={`${typeof API_BASE !== 'undefined' ? API_BASE : ''}/api/auth/facebook`}
                            className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                          >
